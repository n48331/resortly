	...
	return (
		<div className='margin' id='community'>
			<section className={styles['community']}>
				...
				<span className={styles['text']}>WORK AT STOCREDIT</span>
				<h2>Join our mission</h2>
				<p>We&apos;re looking for people who want make stock market trading effective</p>
				<div className={styles['feature']}>
					<a href={waLink('I would like to work at STOCREDIT')} target='_blank' rel='noreferrer noopener'>
						<motion.button
...
function waLink(msg) {
	...
	params.append('phone', '917022473637')

        ...
        <div id='about' className='margin'>
            <section className={styles['about']}>
                ...
                <div className={styles['content']}>
                    ...
                    <p>
                        We have been running Stocredit programs and have instructed 150 Professionals and Future Leaders in
            ...
            <section className={styles['text']}>
                <div className={styles['description']}>
                    ...
                    <p>
                        At Stocredit we understand what Indian investors lack,
